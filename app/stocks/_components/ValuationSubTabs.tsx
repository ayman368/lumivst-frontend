...
const TABS = [
    { name: "Grade & Metrics", path: "" },
    { name: "P/E Ratio", path: "/valuation/pe-ratio" },
    { name: "Capital Structure", path: "/valuation/capital-structure" }
];

export function ValuationSubTabs() {
    const pathname = usePathname();
    const params = useParams();
    const symbol = params.symbol as string;
    const basePath = `/stocks/${symbol}/valuation`;
