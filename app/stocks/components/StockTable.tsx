...
//                                             case 'approval_with_controls':
//                                                 content = <span className="text-gray-900">{stock.approval_with_controls || '-'}</span>;
//                                                 break;

//                                             case 'purge_amount':
//                                                 content = <span className="text-gray-900">{formatPurgeAmount(stock.purge_amount)}</span>;
//                                                 break;

//                                             case 'marginable_percent':
//                                                 content = <span className="font-bold text-gray-900">{formatMarginable(stock.marginable_percent)}</span>;
//                                                 break;
