        ...
        <div className={`bg-white border-r border-gray-200 flex flex-col transition-all duration-300 ease-in-out overflow-hidden flex-shrink-0 ${isOpen ? 'w-64' : 'w-0'}`}>
            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
                ...
                <FilterAccordion title="INDUSTRY FILTERS" defaultOpen={false} collapseSignal={collapseSignal}>
                    <div className="space-y-3">
                        ...
                        <div className="border-t border-gray-100 pt-3">
                            <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Shariah & Margin</div>
                            <CustomMultiSelect options={filterOptions.shariahStatuses} selected={filters.approval_with_controls as string[]} onChange={(v) => set({ approval_with_controls: v as any })} placeholder="Shariah Status" icon={Filter} />
                            <div className="mt-2">
                                <RangeFilter label="Purge Amount" minValue={filters.purge_amount_min} maxValue={filters.purge_amount_max} onMinChange={(v) => set({ purge_amount_min: v })} onMaxChange={(v) => set({ purge_amount_max: v })} />
                                <RangeFilter label="Marginable %" minValue={filters.marginable_percent_min} maxValue={filters.marginable_percent_max} onMinChange={(v) => set({ marginable_percent_min: v })} onMaxChange={(v) => set({ marginable_percent_max: v })} />
                            </div>
                        </div>
                    </div>
                </FilterAccordion>
                ...
                <FilterAccordion title="SMARTSELECT RATINGS" collapseSignal={collapseSignal}>
                    <div className="mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Relative Strength</div>
                        ...
                        <RangeFilter label="RS 1M (0-99)" minValue={filters.rank_1m_min} maxValue={filters.rank_1m_max} onMinChange={(v) => set({ rank_1m_min: v })} onMaxChange={(v) => set({ rank_1m_max: v })} />
                        <RangeFilter label="RS 3M (0-99)" minValue={filters.rank_3m_min} maxValue={filters.rank_3m_max} onMinChange={(v) => set({ rank_3m_min: v })} onMaxChange={(v) => set({ rank_3m_max: v })} />
                        <RangeFilter label="RS 6M (0-99)" minValue={filters.rank_6m_min} maxValue={filters.rank_6m_max} onMinChange={(v) => set({ rank_6m_min: v })} onMaxChange={(v) => set({ rank_6m_max: v })} />
                        <RangeFilter label="RS 9M (0-99)" minValue={filters.rank_9m_min} maxValue={filters.rank_9m_max} onMinChange={(v) => set({ rank_9m_min: v })} onMaxChange={(v) => set({ rank_9m_max: v })} />
                        <RangeFilter label="RS 12M (0-99)" minValue={filters.rank_12m_min} maxValue={filters.rank_12m_max} onMinChange={(v) => set({ rank_12m_min: v })} onMaxChange={(v) => set({ rank_12m_max: v })} />
                    </div>
                    <div className="border-t border-gray-100 pt-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Accumulation / Distribution</div>
                ...
                <FilterAccordion title="PRICE & VOLUME" collapseSignal={collapseSignal}>
                    <div className="mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price</div>
                        <RangeFilter label="Close" minValue={filters.price_min} maxValue={filters.price_max} onMinChange={(v) => set({ price_min: v })} onMaxChange={(v) => set({ price_max: v })} />
                    ...
                    <div className="border-t border-gray-100 pt-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Volume & Liquidity</div>
                ...
                <FilterAccordion title="MOVING AVERAGES" collapseSignal={collapseSignal}>
                    {/* Price vs Averages % */}
                    <div className="mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price vs Averages %</div>
                        <RangeFilter label="vs SMA 10%" minValue={filters.price_vs_sma_10_min} maxValue={filters.price_vs_sma_10_max} onMinChange={(v) => set({ price_vs_sma_10_min: v })} onMaxChange={(v) => set({ price_vs_sma_10_max: v })} />
                        <RangeFilter label="vs SMA 21%" minValue={filters.price_vs_sma_21_min} maxValue={filters.price_vs_sma_21_max} onMinChange={(v) => set({ price_vs_sma_21_min: v })} onMaxChange={(v) => set({ price_vs_sma_21_max: v })} />
                    ...
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price − SMA</div>
                    ...
                    {/* MA Cross / Boolean */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price vs MAs</div>
                        <CheckboxGroup label="Price > 10EMA" options={['Yes', 'No']} selected={boolVal(filters.price_gt_ema10)} onChange={boolSet('price_gt_ema10')} />
                        <CheckboxGroup label="Price > 21EMA" options={['Yes', 'No']} selected={boolVal(filters.price_gt_ema21)} onChange={boolSet('price_gt_ema21')} />
                        <CheckboxGroup label="Price > 30WMA" options={['Yes', 'No']} selected={boolVal(filters.price_gt_30w)} onChange={boolSet('price_gt_30w')} />
                        <CheckboxGroup label="Price > 40WMA" options={['Yes', 'No']} selected={boolVal(filters.price_gt_40w)} onChange={boolSet('price_gt_40w')} />
                        <CheckboxGroup label="30WMA > 40WMA" options={['Yes', 'No']} selected={boolVal(filters.wma30_gt_wma40)} onChange={boolSet('wma30_gt_wma40')} />
                    </div>
                    {/* MA Comparisons */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">MA Comparison</div>
                        ...
                        <CheckboxGroup label="EMA10 > 50SMA" options={['Yes', 'No']} selected={boolVal(filters.ema10_gt_sma50)} onChange={boolSet('ema10_gt_sma50')} />
                        <CheckboxGroup label="EMA10 > 200SMA" options={['Yes', 'No']} selected={boolVal(filters.ema10_gt_sma200)} onChange={boolSet('ema10_gt_sma200')} />
                        <CheckboxGroup label="EMA21 > 50SMA" options={['Yes', 'No']} selected={boolVal(filters.ema21_gt_sma50)} onChange={boolSet('ema21_gt_sma50')} />
                        <CheckboxGroup label="EMA21 > 200SMA" options={['Yes', 'No']} selected={boolVal(filters.ema21_gt_sma200)} onChange={boolSet('ema21_gt_sma200')} />
                        <CheckboxGroup label="SMA10 > SMA21 > SMA50" options={['Yes', 'No']} selected={boolVal(filters.ma_10_21_50)} onChange={boolSet('ma_10_21_50')} />
                        <CheckboxGroup label="SMA50 > SMA150" options={['Yes', 'No']} selected={boolVal(filters.sma50_gt_sma150)} onChange={boolSet('sma50_gt_sma150')} />
                        <CheckboxGroup label="SMA50 > SMA200" options={['Yes', 'No']} selected={boolVal(filters.sma50_gt_sma200)} onChange={boolSet('sma50_gt_sma200')} />
                        ...
                        <CheckboxGroup label="SMA150 > SMA200" options={['Yes', 'No']} selected={boolVal(filters.sma150_gt_sma200)} onChange={boolSet('sma150_gt_sma200')} />
                    </div>
                    {/* 200SMA Trend */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">200SMA Trend</div>
                        <CheckboxGroup label="200SMA > 1M Ago" options={['Yes', 'No']} selected={boolVal(filters.sma200_gt_sma200_1m_ago)} onChange={boolSet('sma200_gt_sma200_1m_ago')} />
                        <CheckboxGroup label="200SMA > 2M Ago" options={['Yes', 'No']} selected={boolVal(filters.sma200_gt_sma200_2m_ago)} onChange={boolSet('sma200_gt_sma200_2m_ago')} />
                        <CheckboxGroup label="200SMA > 3M Ago" options={['Yes', 'No']} selected={boolVal(filters.sma200_gt_sma200_3m_ago)} onChange={boolSet('sma200_gt_sma200_3m_ago')} />
                        <CheckboxGroup label="200SMA > 4M Ago" options={['Yes', 'No']} selected={boolVal(filters.sma200_gt_sma200_4m_ago)} onChange={boolSet('sma200_gt_sma200_4m_ago')} />
                        <CheckboxGroup label="200SMA > 5M Ago" options={['Yes', 'No']} selected={boolVal(filters.sma200_gt_sma200_5m_ago)} onChange={boolSet('sma200_gt_sma200_5m_ago')} />
                    </div>
                    {/* EMA & SMA Daily */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">EMA & SMA (Daily)</div>
                    ...
                    {/* SMA Weekly */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">SMA (Weekly)</div>
                    ...
                    {/* 200MA Historical */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">200MA Historical</div>
                        <RangeFilter label="200MA (1M Ago)" minValue={filters.sma_200_1m_min} maxValue={filters.sma_200_1m_max} onMinChange={(v) => set({ sma_200_1m_min: v })} onMaxChange={(v) => set({ sma_200_1m_max: v })} />
                        <RangeFilter label="200MA (2M Ago)" minValue={filters.sma_200_2m_min} maxValue={filters.sma_200_2m_max} onMinChange={(v) => set({ sma_200_2m_min: v })} onMaxChange={(v) => set({ sma_200_2m_max: v })} />
                        <RangeFilter label="200MA (3M Ago)" minValue={filters.sma_200_3m_min} maxValue={filters.sma_200_3m_max} onMinChange={(v) => set({ sma_200_3m_min: v })} onMaxChange={(v) => set({ sma_200_3m_max: v })} />
                        <RangeFilter label="200MA (4M Ago)" minValue={filters.sma_200_4m_min} maxValue={filters.sma_200_4m_max} onMinChange={(v) => set({ sma_200_4m_min: v })} onMaxChange={(v) => set({ sma_200_4m_max: v })} />
                        <RangeFilter label="200MA (5M Ago)" minValue={filters.sma_200_5m_min} maxValue={filters.sma_200_5m_max} onMinChange={(v) => set({ sma_200_5m_min: v })} onMaxChange={(v) => set({ sma_200_5m_max: v })} />
                    </div>
                    {/* 52-Week Range */}
                    <div className="border-t border-gray-100 pt-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">52-Week Range</div>
                ...
                <FilterAccordion title="RSI: DAILY" collapseSignal={collapseSignal}>
                    ...
                    <div className="border-t border-gray-100 pt-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price MAs vs The Number</div>
                        ...
                        <div className="mt-2 text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">RSI Indicator Cross</div>
                ...
                <FilterAccordion title="RSI: WEEKLY" collapseSignal={collapseSignal}>
                    <div className="mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">RSI (Weekly)</div>
                    ...
                    <div className="border-t border-gray-100 pt-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price MAs vs The Number (W)</div>
                        ...
                        <div className="mt-2 text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">RSI Indicator Cross (W)</div>
                ...
                {/* ── Alrayan ───────────────────────────────────────────────── */}
                <FilterAccordion title="ALRAYAN" collapseSignal={collapseSignal}>
                    {/* PRICE */}
                    <div className="mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price (Daily)</div>
                    ...
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Price (Weekly)</div>
                    ...
                    {/* CCI */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">CCI (Daily)</div>
                    ...
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">CCI (Weekly)</div>
                    ...
                    {/* AROON */}
                    <div className="border-t border-gray-100 pt-3 mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">AROON (Daily)</div>
                    ...
                    <div className="border-t border-gray-100 pt-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">AROON (Weekly)</div>
                ...
                <FilterAccordion title="STAMP FILTERS" collapseSignal={collapseSignal}>
                    ...
                    <div className="border-t border-gray-100 pt-3">
                        ...
                        <CheckboxGroup label="SMA9 > WMA45 (W)" options={['Yes', 'No']} selected={boolVal(filters.stamp_sma9_gt_wma45_weekly)} onChange={boolSet('stamp_sma9_gt_wma45_weekly')} />
                        <CheckboxGroup label="SMA9 RSI > WMA45 (W)" options={['Yes', 'No']} selected={boolVal(filters.stamp_sma9rsi_gt_wma45_weekly)} onChange={boolSet('stamp_sma9rsi_gt_wma45_weekly')} />
                        <CheckboxGroup label="EMA45 RSI > 50 (W)" options={['Yes', 'No']} selected={boolVal(filters.stamp_ema45rsi_gt_50_weekly)} onChange={boolSet('stamp_ema45rsi_gt_50_weekly')} />
                        <CheckboxGroup label="EMA45 CFG > 50 (W)" options={['Yes', 'No']} selected={boolVal(filters.stamp_ema45cfg_gt_50_weekly)} onChange={boolSet('stamp_ema45cfg_gt_50_weekly')} />
                        <CheckboxGroup label="EMA20 SMA3 > 50 (W)" options={['Yes', 'No']} selected={boolVal(filters.stamp_ema20sma3_gt_50_weekly)} onChange={boolSet('stamp_ema20sma3_gt_50_weekly')} />
                        <CheckboxGroup label="EMA45 RSI < STAMP Lines (W)" options={['Yes', 'No']} selected={boolVal(filters.stamp_ema45rsi_lt_stamp_lines_weekly)} onChange={boolSet('stamp_ema45rsi_lt_stamp_lines_weekly')} />
                    </div>
                </FilterAccordion>
                ...
                <FilterAccordion title="RS MOMENTUM & NET SHORT" collapseSignal={collapseSignal}>
                    <div className="mb-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">RS Momentum Trend</div>
                        <CheckboxGroup label="RS > 1W > 4W > 3M > 6M > 1Y" options={['Yes', 'No']} selected={boolVal(filters.rs_momentum_all)} onChange={boolSet('rs_momentum_all')} />
                        <CheckboxGroup label="RS Rating > 1W" options={['Yes', 'No']} selected={boolVal(filters.rs_rating_gt_1w)} onChange={boolSet('rs_rating_gt_1w')} />
                        <CheckboxGroup label="RS 1W > 4W" options={['Yes', 'No']} selected={boolVal(filters.rs_1w_gt_4w)} onChange={boolSet('rs_1w_gt_4w')} />
                        <CheckboxGroup label="RS 3M > 6M" options={['Yes', 'No']} selected={boolVal(filters.rs_3m_gt_6m)} onChange={boolSet('rs_3m_gt_6m')} />
                        <CheckboxGroup label="RS 6M > 1Y" options={['Yes', 'No']} selected={boolVal(filters.rs_6m_gt_1y)} onChange={boolSet('rs_6m_gt_1y')} />
                    </div>
                    <div className="border-t border-gray-100 pt-3">
                        <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-2">Net Short Positions</div>
                        <RangeFilter label="Short % Outstanding" minValue={filters.percent_over_outstanding_min} maxValue={filters.percent_over_outstanding_max} onMinChange={(v) => set({ percent_over_outstanding_min: v })} onMaxChange={(v) => set({ percent_over_outstanding_max: v })} />
                        <RangeFilter label="Short % Free Float" minValue={filters.percent_over_free_float_min} maxValue={filters.percent_over_free_float_max} onMinChange={(v) => set({ percent_over_free_float_min: v })} onMaxChange={(v) => set({ percent_over_free_float_max: v })} />
                        <RangeFilter label="Short Ratio Avg Daily" minValue={filters.ratio_over_avg_daily_min} maxValue={filters.ratio_over_avg_daily_max} onMinChange={(v) => set({ ratio_over_avg_daily_min: v })} onMaxChange={(v) => set({ ratio_over_avg_daily_max: v })} />
                    </div>
                </FilterAccordion>
