...
export default function ACorporateSpreadPage() {
  ...
  useEffect(() => {
    fetch(`${API_BASE_URL}/api/economic-indicators/BAMLC0A3CA?limit=5000`)
      .then(res => res.json())
      .then((json) => {
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2 text-lg">
            Measures the spread of US dollar denominated investment grade corporate debt publicly issued in the US domestic market, rated A.
          </p>
        </div>
      </div>
