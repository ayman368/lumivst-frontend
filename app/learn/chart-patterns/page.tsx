          ...
          {active && (
            <div key={active.id} className="detail-section">
              ...
              <div style={{
                ...
                <div style={{ height: '3px', backgroundColor: active.color, position: 'absolute', top: 0, left: 0, right: 0 }} />
                {/* @ts-ignore */}
                {active.diagramPosition === 'bottom' ? (
                  ...
                  <>
                    ...
                    <p style={{ color: '#5C4A2A', fontSize: '15px', lineHeight: '1.9', margin: '0 0 20px 0' }}>{active.paragraphs[1]}</p>
                    <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                      {/* @ts-ignore */}
                      {active.extraImg && <img src={active.extraImg} alt="Rising Wedge" style={imgStyle} className="img-hover" />}
                    </div>
                    <p style={{ color: '#5C4A2A', fontSize: '15px', lineHeight: '1.9', margin: 0 }}>{active.paragraphs[2]}</p>
                  </>
                ) : (
